        ...
        child: BubbleBottomBar(
          ...
          items: <BubbleBottomBarItem>[
            BubbleBottomBarItem(
              ...
              activeIcon: Icon(Icons.search, size: 25, color: Colors.white),
              title: Text(
            ...
            BubbleBottomBarItem(
              backgroundColor: Theme.of(context).primaryColorDark,
              icon: Icon(Icons.music_note, size: 25),
              activeIcon:
            ...
            BubbleBottomBarItem(
              ...
              activeIcon: Icon(Icons.favorite, size: 25.0, color: Colors.white),
              title: Text(
            ...
            BubbleBottomBarItem(
              ...
              activeIcon: Icon(Icons.person, size: 25.0, color: Colors.white),
              title: Text(
